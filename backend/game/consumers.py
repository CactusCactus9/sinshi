...
class PongConsumer(AsyncWebsocketConsumer):
    ...
    async def update_ball(self):
        ...
        # print(f"score right  bk: {self.rightPlayer['score']}")
        # print(f"score left bk: {self.leftPlayer['score']}")
        # print(f"position left bk: {self.leftPlayer['y']}")
        # print(f"position right bk: {self.rightPlayer['y']}")
        # if (self.leftPlayer['score'] == 3 or self.rightPlayer['score'] == 3):
        #     self.leftPlayer['score'] = 0
        #     self.rightPlayer['score'] = 0
        #     await self.reset_ball()
