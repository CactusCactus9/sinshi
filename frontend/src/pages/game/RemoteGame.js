...
const RemoteGame = () => {
    ...
    const handleKeyDown = (e) => {
        if (!wsRef.current || !playerRole.current) return;
        
        if ((playerRole.current === 'leftPlayer' && (e.key === 'ArrowUp' || e.key === 'ArrowDown')) ||
            (playerRole.current === 'rightPlayer' && (e.key === 'ArrowUp' || e.key === 'ArrowDown'))) {
